...
根地址空白页、`/alljobs/` 完整首页与 Kevin 导航标识已发布，线上检查通过。

## 当前实现

- AI Native Builder 职业经历已按 `简历_ai产品设计师.png` 更新：个人产品实践、得物 C 端体验设计、哔哩哔哩资深美术设计、字节跳动资深创意设计、阿里/饿了么资深视觉设计，以及广告公司与自由设计经历；职责压缩为结果型简述。构建与页面文本检查通过，待部署。
